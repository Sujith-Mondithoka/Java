...
SRC = Path("/home/user/Java/frontend-interview-prep")
OUT = Path("/home/user/Java/frontend-interview-prep/pdf")
...
ORDER = ["README.md", "01-javascript.md", "02-react.md", "03-nextjs.md",
         ...
         "10-your-projects.md", "11-typescript-redux-testing.md",
         "12-final-cheatsheet.md"]
...
<div class="cover">
  ...
  <h1>Frontend Developer<br>WeMakeScholars</h1>
  <div class="rule"></div>
  <div class="sub">React &middot; Next.js &middot; Performance &amp; SEO &middot; Machine Coding &middot; HR<br>
  Prepared for Sujith Mondithoka &middot; Interview: 10:00 AM</div>
  <div class="legend">
    ...
    return (f"<!doctype html><html><head><meta charset='utf-8'>"
            f"<title>Frontend Interview Prep</title><style>{CSS}</style></head>"
...
def stamp(pdf_path: Path, out_path: Path, footer: str):
    ...
    writer.add_metadata({"/Title": "Frontend Developer Interview Prep - WeMakeScholars",
                         "/Author": "Sujith Mondithoka",
                         "/Subject": "React, Next.js, performance, SEO and interview Q&A"})
...
def main():
    ...
    render(html_path, tmp_pdf)
    final = OUT / "WeMakeScholars-Frontend-Interview-Prep.pdf"
    total = stamp(tmp_pdf, final, "Frontend Developer Interview Prep  |  WeMakeScholars")
