...
def main():
    raw = (SRC / "12-final-cheatsheet.md").read_text(encoding="utf-8")
...
<div class="masthead">
  ...
  <div class="sub">Frontend Developer &middot; WeMakeScholars &middot; 07:20&ndash;08:00 &middot;
...
<div class="cols">{md.convert(body_md)}</div></body></html>"""
    ...
    out = OUT / "Cheat-Sheet-Morning-Revision.pdf"
    render(hp, out)
