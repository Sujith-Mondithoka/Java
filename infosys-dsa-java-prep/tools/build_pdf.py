...
SRC = Path("/home/user/Java/infosys-dsa-java-prep")
OUT = Path("/home/user/Java/infosys-dsa-java-prep/pdf")
...
ORDER = ["README.md", "01-core-java.md", "02-java8-functional.md",
         ...
         "08-sql-and-databases.md", "09-dsa-arrays-strings.md",
         "10-dsa-structures.md", "11-system-design.md", "12-your-experience.md",
         "13-hr-and-behavioural.md", "14-delivery-and-code-review.md",
         "15-testing-build-agile.md", "16-final-cheatsheet.md"]
...
<div class="cover">
  ...
  <h1>Java, Spring Boot &amp; DSA<br>Infosys</h1>
  <div class="rule"></div>
  <div class="sub">Core Java &middot; Spring Boot &middot; JPA &middot; DSA &middot; SQL &middot; HR<br>
  Prepared for Sujith Mondithoka &middot; Interview: Saturday 26 September</div>
  <div class="legend">
...
def stamp(pdf_path: Path, out_path: Path, footer: str):
    ...
    writer.add_metadata({"/Title": "Java Backend Interview Prep - Infosys",
                         ...
                         "/Subject": "Core Java, Spring Boot, JPA, DSA and interview Q&A"})
...
def main():
    ...
    render(html_path, tmp_pdf)
    final = OUT / "Infosys-Java-SpringBoot-DSA-Prep.pdf"
