...
def main():
    raw = (SRC / "16-final-cheatsheet.md").read_text(encoding="utf-8")
...
<div class="masthead">
  ...
  <div class="sub">Java, Spring Boot &amp; DSA &middot; Infosys &middot; Saturday 26 September &middot;
...
<div class="cols">{md.convert(body_md)}</div></body></html>"""
    ...
    out = OUT / "Infosys-DSA-Java-Cheat-Sheet.pdf"
    render(hp, out)
