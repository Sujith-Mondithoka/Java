...
SRC = Path("/home/user/Java/lloyds-java-interview-prep")
OUT = Path("/home/user/Java/lloyds-java-interview-prep/pdf")
...
ORDER = ["README.md", "01-core-java.md", "02-java8-functional.md",
         ...
         "11-your-experience.md", "12-behavioural-and-values.md",
         "13-engineering-practice.md", "14-final-cheatsheet.md"]
...
<div class="cover">
  ...
  <h1>Software Engineer<br>Lloyds</h1>
  <div class="rule"></div>
  <div class="sub">Core Java &middot; Spring Boot &middot; Microservices &middot; Testing &middot; SQL<br>
  Prepared for Vallu Ravikoti Narendra</div>
  <div class="legend">
    ...
    return (f"<!doctype html><html><head><meta charset='utf-8'>"
            f"<title>Lloyds Java Interview Prep</title><style>{CSS}</style></head>"
...
def stamp(pdf_path: Path, out_path: Path, footer: str):
    ...
    writer.add_metadata({"/Title": "Software Engineer Interview Prep - Lloyds",
                         "/Author": "Vallu Ravikoti Narendra",
                         "/Subject": "Core Java, Spring Boot, microservices, testing and interview Q&A"})
...
def main():
    ...
    render(html_path, tmp_pdf)
    final = OUT / "Lloyds-Java-Interview-Prep.pdf"
    total = stamp(tmp_pdf, final, "Software Engineer Interview Prep  |  Lloyds")
